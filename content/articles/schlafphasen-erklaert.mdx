...
historie:
  ...
  - datum: 2026-08-13
    notiz: "Redaktionelle Überarbeitung: Prozesssprache aus dem Fließtext entfernt, Praxis-Fazit-Boxen je Quelle ergänzt, Hero-Chart durch Anteils-Diagramm ersetzt, zwei Inline-Diagramme ergänzt (Genauigkeits-Spanne, Abweichung Gesamtschlafzeit), Datei zu MDX konvertiert. Weiterhin entwurf, wartet auf menschliches Review."
  - datum: 2026-08-14
    notiz: "Korrekturen: Praxis-Fazit-Boxen je Quelle durch eine einzelne Box am Artikelende ersetzt (Alltagssprache, aus dem Gesamttext); Einzelwert-Diagramm zur Gesamtschlafzeit entfernt (kein Chart für Einzelwerte ohne Streuung); stattdessen zwei boxplot-artige Spannweiten-Diagramme mit echten Konfidenzintervallen aus Lee YJ et al. (2025) recherchiert und ergänzt; Genauigkeits-Diagramm um Schlaf-Wach-Vergleichszeile erweitert. Weiterhin entwurf, wartet auf menschliches Review."
quellen:
  ...
  - aussage: "Meta-Analyse über 24 Studien und 798 Teilnehmende findet, dass Consumer-Wearables gegenüber Polysomnographie die Gesamtschlafzeit im Mittel um rund 16,9 Minuten (95%-KI −26,3 bis −7,4) und die Schlafeffizienz um rund 4,7 Prozentpunkte (95%-KI −7,1 bis −2,3) unterschätzen, die Einschlaflatenz um rund 2,6 Minuten (95%-KI 0,6 bis 4,5) und die nächtliche Wachzeit (WASO) um rund 13,3 Minuten (95%-KI 4,5 bis 22,0) dagegen überschätzen."
    studientyp: "peer-reviewed"
...
praxisfazit:
  - "Verändern sich Tiefschlaf- und Traumschlaf-Anteile über die Jahre in den eigenen Trackingdaten kaum, ist das normal — und ein mit dem Alter sinkender Traumschlaf-Anteil ist ein gewöhnlicher Alterungseffekt, kein Warnsignal für sich allein."
  - "Zeigt das Tracking an einem Abend deutlich mehr oder weniger als drei bis vier Schlafzyklen, ist das für sich genommen kein Grund zur Sorge — von Nacht zu Nacht schwankt das bei gesunden Menschen stark."
  - "Ein Wearable kann nicht ins Gehirn schauen wie ein Schlaflabor — bei anhaltenden Schlafproblemen sagt die App allein nichts Verlässliches über die Ursache, dafür braucht es ärztlichen Rat."
  - "Der Gesamtschlafzeit und dem Trend über mehrere Nächte darf man mehr vertrauen als der genauen Prozentzahl für Tiefschlaf oder Traumschlaf einer einzelnen Nacht — dort schwankt die Genauigkeit zwischen den Geräten am stärksten."
affiliate: true
entwurf: true
offenePunkte:
  ...
  - "Kein Diagramm für 'Zyklusdauer im Nachtverlauf' ergänzt: Cajochen et al. (2024) liefert Median/Zykluszahl, aber keine aus dem Paper rekonstruierbare Wertereihe je Zyklusposition — ein Liniendiagramm dazu wäre nicht durch die Quelle gedeckt (CLAUDE.md Abschnitt 2, 'Diagramme')."
  - "Konfidenzintervalle für Lee YJ et al. (2025) über Europe-PMC-Abstract-Extraktion recherchiert (nicht aus dem Volltext) — vor Freigabe gegen den PDF-Volltext gegenprüfen."
featured: true
istSaeule: true
...
REM-Schlaf (Patel et al., 2024) — die Grafik oben zeigt diese Verteilung. Diese Prozentzahlen
sind ein Richtwert, keine für jeden Menschen und jede Nacht fixierte Zielgröße — mehr dazu im
Abschnitt „Was die Studienlage (noch) nicht beantwortet" am Ende. Wichtig ist außerdem der
...
im Mittel um rund 17 Minuten und die Schlafeffizienz um rund 4,7 Prozentpunkte, während sie die
Einschlaflatenz um rund 2,6 Minuten und die nächtliche Wachzeit (WASO) um rund 13,3 Minuten
überschätzen (Lee YJ et al., 2025). Das sind systematische Verzerrungen bei grundlegenden
Schlafparametern — nicht erst bei der feineren Frage, welche Schlafphase gerade vorliegt. Die
Diagramme unten zeigen dazu nicht nur diese Mittelwerte, sondern auch die Schwankungsbreite
zwischen den 24 zugrunde liegenden Studien (95%-Konfidenzintervall).
...
Schlafphase gerade vorliegt — das Diagramm unten zeigt diesen Unterschied direkt. Für eine
medizinische Einschätzung — etwa bei Verdacht auf eine Schlafstörung — ersetzt keines dieser
Consumer-Geräte eine Untersuchung im Schlaflabor; Polysomnographie bleibt der diagnostische
Goldstandard, an dem sich alle hier genannten Zahlen überhaupt erst messen lassen.

<Chart id="schlafphasen-genauigkeit-bereich" lang={frontmatter.sprache} />

## Was die Studienlage (noch) nicht beantwortet

Zwei Lücken bleiben trotz der oben zitierten Studienlage offen. Erstens: Wie genau sich Leicht-,
Tief- und REM-Schlaf bei jüngeren, gesunden Erwachsenen im Detail prozentual verteilen, ist
nicht durch eine einzelne, allgemein anerkannte Referenzzahl geklärt — die große Studienlage zu
Schlafarchitektur bildet vor allem ab, wie sich die Anteile über Alter und Lebensphase
verändern, nicht eine fixe Zielgröße für einen bestimmten Zeitpunkt im Erwachsenenleben. Die im
Artikel genannte Verteilung ist deshalb ein gängiger Richtwert, keine exakt aus einer einzelnen
Studie hergeleitete Zahl. Zweitens: Wie genau Wearables Tiefschlaf im Vergleich zu anderen
Phasen erkennen, ist nicht in einer einzelnen, geräteübergreifend gültigen Kennzahl geklärt —
die Genauigkeit schwankt laut den zitierten Vergleichsstudien stark zwischen Geräten (siehe
Diagramm oben). Eine Aussage wie "Wearables erkennen Tiefschlaf zu X% richtig" ist mit der
aktuellen Studienlage nicht zu treffen.
