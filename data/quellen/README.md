...
Das Praxis-Fazit ("Was heißt das für die Praxis?") ist **kein Feld pro Quelle** — es ist eine
einzelne Zusammenfassung der wichtigsten Konsequenzen aus dem gesamten Artikel, gepflegt als
`praxisfazit` im Artikel-Frontmatter (siehe `/content/README.md` und CLAUDE.md Abschnitt 2,
"Praxis-Fazit").
