...
| Schritt | Datei | Tut |
|---|---|---|
| 1. Recherche | [`pipeline/01-recherche.md`](pipeline/01-recherche.md) | 6–10 Studien finden, jede DOI gegen Crossref verifizieren → `/data/quellen/<slug>.json` |
...
vollständiger Durchlauf aussieht.
